...
export class TreantAstVisitor extends AstVisitor<object> {
  ...
  visitElseIfStatementNode(elseIfStatement: ElseIfStatementNode): object {
    return {
      ...
      children: [
        ...
        ...elseIfStatement.statements.map((s) => this.visit(s)),
      ],
    };
  }
  ...
  visitForLoopNode(forLoopNode: ForLoopNode): object {
    return {
      ...
      children: [
        ...
        ...forLoopNode.statements.map((s) => this.visit(s)),
      ],
    };
  }
  ...
  visitFunctionCallNode(functionCall: FunctionCallNode): object {
    return {
      ...
      children: [
        ...
        ...functionCall.args.map((s) => this.visit(s)),
      ],
    };
  }
  ...
  visitIfStatementNode(ifStatement: IfStatementNode): object {
    return {
      ...
      children: [
        ...
        ...ifStatement.statements.map((s) => this.visit(s)),
        ...ifStatement.elseIfs.map((s) => this.visit(s)),
  ...
  visitUnaryLogicalNode(logic: UnaryLogicalNode): object {
    return {
      ...
      children: [
        this.visitUnaryLogicalOperation(logic.operation),
        this.visit(logic.left),
      ],
    };
  }
  ...
  visitWhileLoopNode(whileLoop: WhileLoopNode): object {
    return {
      ...
      children: [
        ...
        ...whileLoop.statements.map((s) => this.visit(s)),
      ],
    };
  }
