...
export interface TypeScriptParserVisitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by `TypeScriptParser.optionalParameterList`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitOptionalParameterList?: (ctx: OptionalParameterListContext) => Result;
	...
	/**
	 * Visit a parse tree produced by `TypeScriptParser.lastElement`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitLastElement?: (ctx: LastElementContext) => Result;
	...
	/**
	 * Visit a parse tree produced by `TypeScriptParser.lastArgument`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitLastArgument?: (ctx: LastArgumentContext) => Result;
