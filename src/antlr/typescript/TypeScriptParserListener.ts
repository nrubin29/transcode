...
import { OptionalParameterListContext } from "./TypeScriptParser";
...
import { EmptyStatementContext } from "./TypeScriptParser";
...
import { LastElementContext } from "./TypeScriptParser";
...
import { LastArgumentContext } from "./TypeScriptParser";
...
export interface TypeScriptParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by `TypeScriptParser.optionalParameterList`.
	 * @param ctx the parse tree
	 */
	enterOptionalParameterList?: (ctx: OptionalParameterListContext) => void;
	/**
	 * Exit a parse tree produced by `TypeScriptParser.optionalParameterList`.
	 * @param ctx the parse tree
	 */
	exitOptionalParameterList?: (ctx: OptionalParameterListContext) => void;
	...
	/**
	 * Enter a parse tree produced by `TypeScriptParser.lastElement`.
	 * @param ctx the parse tree
	 */
	enterLastElement?: (ctx: LastElementContext) => void;
	/**
	 * Exit a parse tree produced by `TypeScriptParser.lastElement`.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by `TypeScriptParser.lastArgument`.
	 * @param ctx the parse tree
	 */
	enterLastArgument?: (ctx: LastArgumentContext) => void;
	/**
	 * Exit a parse tree produced by `TypeScriptParser.lastArgument`.
	 * @param ctx the parse tree
	 */
